...
***/
/****************************************************/
program define getmatchedcohort, rclass
...
confirm numeric var gender
confirm numeric var startdate
confirm numeric var enddate
confirm numeric var yob
confirm numeric var indexdate
**
...
return scalar nomtch = `tomatch'-`totalfoundmatch'
