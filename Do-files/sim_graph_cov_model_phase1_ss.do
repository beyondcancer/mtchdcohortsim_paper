...
xlabel(3 "cox_uadj" 4 "cox_adj" 5 "cox_match" 6 "p_uadj" 7 "p_adj" 8 "p_match", labsize(2)) yline(95, lcol(black)) xtitle("") ///
...
graph combine cov_10_smallco_model cov_7_smallcon_model cov_5_smallcon_model, xcommon ycommon imargin(0 0 0 0) name(cov_smallconf, replace)
 
 
graph export "$resultsDir\sim_graph_cov_model_all_smallconf_${nsim}_${type}.emf", replace


graph combine cov_10_noconf_model cov_7_noconf_model cov_5_noconf_model, xcommon ycommon
